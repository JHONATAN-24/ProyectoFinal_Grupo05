...
public class RegistroJDM_Maven extends javax.swing.JFrame {
    SetEncuestadores setEnc = new SetEncuestadores();
    SetParticipantes setPart = new SetParticipantes();
    
    public RegistroJDM_Maven() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Iconos/Icono de Registro de JDM Surveys (PNG).png"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        InicioJDM_Maven ventana = new InicioJDM_Maven();
    ...
    private void btnGuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarDatosActionPerformed
        ...
        if(rbEncuestador.isSelected()){
            ...
            setEnc.agregarEncuestador(nuevoEncuestador);
            ...
            SeccionEnc_Maven nuevoMenu = new SeccionEnc_Maven(setEnc);
            ...
            setPart.agregarParticipante(nuevoParticipante);
            JOptionPane.showMessageDialog(this,"¡Participante Registrado!");

            //Metodo para limpiar los controles
            limpiarControles();

            //SeccionParticipantes nuevoMenup = new SeccionParticipantes(setPart);
