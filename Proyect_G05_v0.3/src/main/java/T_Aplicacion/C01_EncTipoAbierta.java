...
public class C01_EncTipoAbierta extends javax.swing.JFrame {
   
    ListaEncuestadores T_listaEnc4 = new ListaEncuestadores();
    SetEncuesta nuevoEnc = new SetEncuesta();
    ...
    private void btnPublicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPublicarActionPerformed
        try {
            ...
            A04_MenuEnc T_volverMenu = new A04_MenuEnc(T_listaEnc4, codigoEncuestador,
