...
public class B02_CrearEncuestas extends javax.swing.JPanel {

    //Atributo para instanciar un jframe (MenuEncuestador)
    private A04_MenuEnc T_menuEnc; //Funcionalidad que va a tener es poder poner al jframe Invisible
    ...
    public B02_CrearEncuestas(A04_MenuEnc T_menuEncuestador, ListaEncuestadores encuestador, String codigoEncuestador, String nombreEncuestador, String apellidoEncuestador) {
        initComponents();
