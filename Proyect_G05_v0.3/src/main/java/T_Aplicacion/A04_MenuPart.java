...
public class A04_MenuPart extends javax.swing.JFrame {
    ...
    private void btnCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCuentaActionPerformed
        A05_CuentasPart panelCuenta = new A05_CuentasPart(
                T_listaPart4, 
                codigoParticipante,
                correoParticipante, 
                nombreParticipante, 
    ...
    public void panelInicial(){
        B01_InicioPart pInicio = new B01_InicioPart();
    ...
    public void panelRecibidas(){
        B04_Recibidas pPlantillas = new B04_Recibidas(
                this, 
                T_listaPart4, 
                codigoParticipante, 
                nombreParticipante, 
