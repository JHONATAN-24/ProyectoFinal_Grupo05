...
public class B04_Recibidas extends javax.swing.JPanel {
    ListaParticipantes T_listaPart9 = new ListaParticipantes();
    private A04_MenuPart T_menuPart;
    private int codigoParticipante;
    private int encuestaId;
    private String nombreParticipante;
    private String apellidoParticipante;
            
    public B04_Recibidas(A04_MenuPart T_menuParticipante, ListaParticipantes participante, int codigoParticipante ,String nombreParticipante, String apellidoParticipante, int encuestaId) {
        initComponents();
    ...
    private void btnAbrirEncuestaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbrirEncuestaActionPerformed
         // Escoger al usuario de la tabla
            ...
            if ("Abierta".equals(estadoEncuesta)) {
                ...
                D01_EncBaseAbierta encuestaBase = new D01_EncBaseAbierta(codigoParticipante, codigoEncuesta);
                ...
                D02_EncBaseCerrada encuestaCerrada = new D02_EncBaseCerrada(codigoParticipante, codigoEncuesta);
