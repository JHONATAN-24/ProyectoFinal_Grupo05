...
public class V04_SeccionEnc extends javax.swing.JFrame {
    ...
    public V04_SeccionEnc(ListaEncuestadores T_encuestador) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblEncuestadores.setMaximumSize(new java.awt.Dimension(788, 800));
        tblEncuestadores.setMinimumSize(new java.awt.Dimension(788, 800));
        tblEncuestadores.setPreferredSize(new java.awt.Dimension(788, 800));
    ...
    private void btnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSiguienteActionPerformed
        ...
        // Obtener valores de la tabla
            ...
            String genero = tblEncuestadores.getValueAt(selectedRow, 3).toString();
            String fechaNacimiento = tblEncuestadores.getValueAt(selectedRow,4).toString();

        // Crear y mostrar nueva ventana
            V05_MenuEnc nuevaVentana = new V05_MenuEnc(T_listaEnc2, codigoEncuestador,
                        nombreEncuestador, apellidoEncuestador, genero, fechaNacimiento);
