...
public class V05_MenuEnc extends javax.swing.JFrame {
    ...
    private void btnEncuestaAbiertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncuestaAbiertaActionPerformed
        ...
        EncuestaTipoAbierta T_TipoAbierta = new EncuestaTipoAbierta(
                T_listaEnc4, 
                codigoEncuestador, 
                nombreEncuestador, 
                apellidoEncuestador, 
    ...
    private void btnEncuestaMixtaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncuestaMixtaActionPerformed
        ...
        EncuestaTipoMixta T_TipoMixta = new EncuestaTipoMixta(
                T_listaEnc4, 
                codigoEncuestador, 
                nombreEncuestador, 
                apellidoEncuestador, 
    ...
    private void btnEncuestaCerradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncuestaCerradaActionPerformed
        ...
        EncuestaTipoCerrada T_TipoCerrada = new EncuestaTipoCerrada(
                T_listaEnc4, 
                codigoEncuestador, 
                nombreEncuestador, 
                apellidoEncuestador, 
    ...
    private void btnCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCuentaActionPerformed
        V11_CuentasEnc panelCuenta = new V11_CuentasEnc(
                T_listaEnc4, 
                codigoEncuestador, 
                nombreEncuestador, 
                apellidoEncuestador, 
    ...
    private void btnComentariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComentariosActionPerformed
        V13_ComentariosEnc panelComentarios = new V13_ComentariosEnc(
                T_listaEnc4, 
                codigoEncuestador, 
                nombreEncuestador, 
                apellidoEncuestador, 
    ...
    public void panelInicial(){
        P06_InicioEncuestador pInicio = new P06_InicioEncuestador();
    ...
    public void panelPlantillas(){
        P07_CrearEncuestas pPlantillas = new P07_CrearEncuestas(this, T_listaEnc4, codigoEncuestador, nombreEncuestador, apellidoEncuestador);
    ...
    public void panelEncuestas(){
        P08_Recientes pEnviadas = new P08_Recientes(T_listaEnc4, codigoEncuestador);
    ...
    public void panelResultados(){
        P10_Resultados pReportes = new P10_Resultados(T_listaEnc4, codigoEncuestador);
