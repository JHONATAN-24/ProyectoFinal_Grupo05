...
public class A05_CuentasPart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbInformacionUsuario.setText("Información de participante");
    ...
    private void btnCambiarCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCambiarCuentaActionPerformed
        ...
        A07_CambiarCuentasPart T_cambiarCuenta = new A07_CambiarCuentasPart();
    ...
    public void PanelInformacion(){
        B06_InfoPlataforma panelInfo = new B06_InfoPlataforma();
        panelInfo.setSize(846,472);
