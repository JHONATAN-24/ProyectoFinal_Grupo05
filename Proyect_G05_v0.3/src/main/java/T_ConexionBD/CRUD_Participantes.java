...
public class CRUD_Participantes {
    ...
    public Participante validarCredenciales(String email, String contraseña) {
        Participante participanteRegistrado = null;
            ...
            try (PreparedStatement statement = conexion.prepareStatement(sql)) {
                ...
                try (ResultSet rs = statement.executeQuery()) {
                    if (rs.next()) {
                        ...
                        participanteRegistrado = new Participante(
                            rs.getString("email"),
