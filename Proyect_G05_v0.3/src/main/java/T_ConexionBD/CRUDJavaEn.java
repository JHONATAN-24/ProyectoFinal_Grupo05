...
public class CRUDJavaEn {
    ...
    public List<Encuesta> obtenerListaEncuesta(Connection conexion){    
     List<Encuesta> T_lista = new ArrayList<>();
        String sql = "SELECT id_encuestas, titulo, descripcion, tipo, fechaCreacion, fechaCierre FROM T_Encuestas " + 
                    "ORDER BY id_encuestas DESC";
